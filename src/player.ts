...
export class Player {
  ...
  loadWXImage(data: Uint8Array | string): Promise<any> {
    ...
    return new Promise((res, rej) => {
      const img = typeof Image !== "undefined" ? new Image() : this.canvas!.createImage();
      img.onload = () => {
        res(img);
      };
      ...
      if (typeof data === "string") {
        ...
        img.src = "data:image/png;base64," + (typeof window != "undefined" ? this._arrayBufferToBase64(data) : wx.arrayBufferToBase64(data));
      }
    });
  }
